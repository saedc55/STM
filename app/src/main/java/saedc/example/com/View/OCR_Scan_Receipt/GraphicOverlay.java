 ...
 * </ol>
 */
public class GraphicOverlay<T extends saedc.example.com.View.OCR_Scan_Receipt.GraphicOverlay.Graphic> extends View {
     ...
     * graphics element.  Add instances to the overlay using {@link saedc.example.com.View.OCR_Scan_Receipt.GraphicOverlay#add(Graphic)}.
     */
    public static abstract class Graphic {
        private saedc.example.com.View.OCR_Scan_Receipt.GraphicOverlay mOverlay;

        public Graphic(saedc.example.com.View.OCR_Scan_Receipt.GraphicOverlay overlay) {
            mOverlay = overlay;
        }
